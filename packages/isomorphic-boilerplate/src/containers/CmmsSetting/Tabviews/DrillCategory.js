...
export default function (props) {
  ...
  const onSave = () => {
    ...
    if(pageStatus=="add")
      ...
      dispatch(updateData(sendDate,intDrillCategoryId));    
  };
  React.useEffect(() => { 
    dispatch(initData());
 }, []);
        ...
        <Form>
          <Fieldset>
            ...
            <Input
              ...
              onChange={(event)=>{setStrDrillCategoryName(event.target.value)}}
            />
          </Fieldset>
          <Fieldset>
