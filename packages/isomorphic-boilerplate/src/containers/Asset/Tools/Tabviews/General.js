              ...
              <Row style={rowStyle} gutter={16} justify="start">
                <Col md={4} sm={4} xs={24} style={colStyle}>
                  <Form>
                    <FormItem {...formItemLayout} label="">
                      <Radio name="value"  checked={partFlag} onClick={(event)=>{setPartFlag(locatedFlag?true:false);setLocatedFlag(false)}}> This Tools is part of :</Radio>                                  
                    </FormItem>
                  </Form>                 
                </Col>
                ...
                <Row style={rowStyle} gutter={16} justify="start">
                  <Col md={4} sm={4} xs={24} style={colStyle}>
                    <Form>
                      <FormItem {...formItemLayout} label="">
                        <Radio  name="value"  checked={locatedFlag} onClick={(event)=>{setLocatedFlag(partFlag?true:false);setPartFlag(false);}}  > This Tools is located at :</Radio>                                  
                      </FormItem>
                    </Form>                 
                  </Col>
