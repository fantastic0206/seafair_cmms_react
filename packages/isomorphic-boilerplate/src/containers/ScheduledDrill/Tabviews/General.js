...
export default function(props) {   
  ...
  const selectAssignee=(row)=>{
    ...
    props.setStrAssigneeUser(row.strUserTitle);  
  }
  ...
  React.useEffect(() => {
    // console.log(data);
    if(data != null) {
      setStrAssignedUser(data.strAssigneeUser);
      setStrDrillDescription(data.strDrillDescription);
    }
  }, [data])
  ...
  <div  className="PageContent">
    <InputGroup size="large" style={{ marginBottom: "10px" }}>
      <Row style={rowStyle} gutter={16} justify="start">                 
                ...
                <Fieldset>
                  ...
                  <div style={{position:"relative"}}>                
                    <Input 
                      ...
                      onChange={()=>{setCrewContentModalActive(true)}}
                    /> 
              ...
              <Form>
                <Fieldset>
                  ...
                  <Textarea placeholder="" 
                    ...
                    onChange={(event)=>{setStrDrillDescription(event.target.value); props.setStrDrillDescription(event.target.value)}}                          
                  /> 
              </Fieldset>
              </Form> 
          </Col>
        ...
        <Col md={5} sm={5} xs={24} >
          <div style={{position:"relative"}}>
            <div style={{height: "200px",overflow: "auto",borderRadius: "4px", border: "1px solid rgb(205, 209, 215)", padding: "4px", margin: "4px"}}>
