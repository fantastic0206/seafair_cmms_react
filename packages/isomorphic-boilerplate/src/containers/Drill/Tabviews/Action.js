                    ...
                    <Form>
                        <Fieldset>
                          ...
                          <Textarea placeholder="" 
                            ...
                            rows={2}
                            value={strNarrative}
                             onChange={(event)=>{setStrNarrative(event.target.value);props.strNarrative(event.target.value)}}                               
                          /> 
                      </Fieldset>
                      </Form>                   
                  </Col>         
                    ...
                    <Form>
                        <Fieldset>
                          ...
                          <Textarea placeholder="" 
                            ...
                            onChange={(event)=>{setStrHowImproveFuture(event.target.value);props.strHowImproveFuture(event.target.value)}}                               
                          /> 
                      </Fieldset>
                      </Form>                   
                  </Col>         
