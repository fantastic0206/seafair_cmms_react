          ...
          {column.editing ? (
            ...
            <Header isDragging={snapshot.isDragging}>
              ...
              {/* <PlusIcon
                src={Plus}
                onClick={() =>
                  Ok. On the page, after they hit submit, 
                  can it bring them to a page that says their issue has been reported and to reference ticket # (whatever the ticket number is for the issue)
                  openDrawer({
